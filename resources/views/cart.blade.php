...
{{-- @dd($cart_products[0]->cartItems[0]->product) --}}
                    ...
                    <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="courier" class="form-control select2" id="courier" required>
                                        <option value="" disabled selected hidden></option>
                            ...
                            <div class="row mb-3">
                                <div>
                                    ...
                                    <input type="text" name="address-detail" id="address-detail" class="form-control" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div>
    ...
    $(document).ready(function() {
        ...
        if (!$('.selected-items:checked').length > 0) {
            ...
            $('#courier').on('change', function(){
                if (!$('.selected-items:checked').length > 0) {
                    alert('PILIH DULU PRODUKNYA WOEY!! MAKSA AMAT!')
                    location.reload();
                }
            })
        }
